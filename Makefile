...
api-docs: gen-crd-api-reference-docs  ## Generate API reference documentation
	$(GEN_CRD_API_REFERENCE_DOCS) -api-dir=./api/v1alpha1 -config=./hack/api-docs/config.json -template-dir=./hack/api-docs/template -out-file=./docs/api/v1alpha1/replication.md
...
create-helmchart:
	./hack/create_helm_chart.sh "local" "replication-controller"

.PHONY: create-helmchart-release
create-helmchart-release:
	./hack/create_helm_chart.sh "release" "replication-controller"
